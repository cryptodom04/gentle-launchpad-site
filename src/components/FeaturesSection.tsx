...
const FeaturesSection = () => {
  return <section id="features" className="py-16 sm:py-24 md:py-32 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-12 sm:mb-16 md:mb-20">
          ...
          <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-4 sm:mb-6 px-2">
            Why Creators
            <br />
            <span className="gradient-text">Choose SolFerno</span>
          </h2>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
          {features.map((feature, index) => <div key={feature.title} className="group relative glass rounded-2xl sm:rounded-3xl p-6 sm:p-8 hover:glow-primary transition-all duration-500 card-3d overflow-hidden" style={{
