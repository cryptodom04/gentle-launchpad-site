    ...
    questions: [
      {
        ...
        answer: 'SolFerno is a platform for creating tokens and rugpulls on the Solana blockchain. We enable anyone to create their own SPL token without having to write code or understand the technical details.'
      },
      {
        question: 'How do I start creating tokens?',
        answer: 'Simply go to the "Create" page, fill out the form with your token parameters (name, symbol, supply) and pay the fee. The token will be created automatically.'
      },
      {
    ...
    questions: [
      {
        ...
        answer: 'The cost of creating a token depends on the selected parameters. The base price starts at 1.5 SOL and includes all necessary blockchain operations.'
      },
      {
